...
" And is for use in gvim not vim

" Happy Hacking color scheme {{{1
set background=dark
"PB: commented out following line as this was
"    clearing my redundant whitepsace highighting
"hi clear
if exists("syntax_on")
   syntax reset
endif
...
"TODO
" inner {{{1
hi Normal                  gui=none        guifg=#88bb88 guibg=#111818
