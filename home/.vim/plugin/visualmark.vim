"   Original script lives here http://www.vim.org/scripts/script.php?script_id=1026
" I made some changes for myself // yuriy.ershov@gmail.com
"
" Visual Mark
...
if !hasmapto('<Plug>Vm_remove_all_signs')
  map <silent> <unique> mM <Plug>Vm_remove_all_signs 
endif
nnoremap <silent> <script> <Plug>Vm_remove_all_signs	:sign unplace *<cr>
